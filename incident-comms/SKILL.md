...
- NEVER use em dashes (—) in the message. They feel robotic. Use a comma, period, or rewrite the sentence instead (e.g. "All partners were affected, no data was visible" not "All partners were affected — no data was visible")
